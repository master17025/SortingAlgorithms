...
int NumberOfElements = 1e1; //30

// int NumberOfElements = 30e6;
// Time taken to sort the list using Merge sort : 57448.6 milliseconds

// int NumberOfElements = 20e8;
// Time taken to sort the list using Counting sort : 57093.3 milliseconds

// int NumberOfElements = 9e8;
//Time taken to sort the list using Radix sort: 58664.4 milliseconds
